 ...
 * @version 1.0
 */
class MatrixSubtraction(inputPanel: InputPanel) : ContentMatrixPanel(inputPanel) {
    ...
    init {
        ...
        val btnAdd = Button("Subtract!") {
            val m0 = inputPanel.matrix0.getMatrix()
            val m1 = inputPanel.matrix1.getMatrix()
            try {
                lblOutput_1.setMatrix(m0.minus(m1))
                lblOutput_2.setMatrix(m1.minus(m0))
