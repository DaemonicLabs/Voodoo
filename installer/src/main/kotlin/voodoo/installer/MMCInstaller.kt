...
object MMCInstaller {
    ...
    private val directories = Directories.get(moduleName = "INSTALLER-MULTIMC")
...
//    val kit = Toolkit.getDefaultToolkit()
    ...
    private suspend fun selfupdate(instanceDir: File, installerUrl: String, phase: Phase): File? {
        ...
        val currentJarFile = File(MMCInstaller::class.java.protectionDomain.codeSource.location.toURI())
