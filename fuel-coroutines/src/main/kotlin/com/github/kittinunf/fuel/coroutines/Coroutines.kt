...
@Deprecated("please use 'com.github.kittinunf.fuel.coroutines.awaitByteArray()'", ReplaceWith("com.github.kittinunf.fuel.coroutines.awaitByteArray()", "deserializable"))
suspend fun Request.awaitResponseResult(): ByteArray = awaitByteArray()

@Deprecated("please use 'com.github.kittinunf.fuel.coroutines.awaitObjectResult(deserializable)'", ReplaceWith("com.github.kittinunf.fuel.coroutines.awaitObjectResult(deserializable)"))
