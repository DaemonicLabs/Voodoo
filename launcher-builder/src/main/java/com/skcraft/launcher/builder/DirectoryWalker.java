...
public abstract class DirectoryWalker {
    ...
    public final void walk(@NonNull File dir) throws IOException {
        if (dir == null) {
            throw new java.lang.NullPointerException("dir is marked @NonNull but is null");
        }
        walk(dir, "");
    }
    ...
    private void walk(@NonNull File dir, @NonNull String basePath) throws IOException {
        ...
        if (basePath == null) {
            throw new java.lang.NullPointerException("basePath is marked @NonNull but is null");
        }
        if (!dir.isDirectory()) {
