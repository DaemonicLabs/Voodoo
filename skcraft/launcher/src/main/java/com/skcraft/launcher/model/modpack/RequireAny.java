...
public class RequireAny implements Condition {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof RequireAny)) return false;
        final RequireAny other = (RequireAny) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof RequireAny;
    }
    ...
    public String toString() {
        return "RequireAny(features=" + this.getFeatures() + ")";
    }
}
